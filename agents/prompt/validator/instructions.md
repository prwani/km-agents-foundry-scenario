...
Use Code Interpreter to inspect the candidate PPTX package, slide text, shape names, protected elements, and rendered slide images against the attached canonical template and validation policy.
