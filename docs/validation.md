...
- `azure.yaml` contains one direct-code Foundry hosted agent with deterministic validation.
...
- Uploaded content and secrets are excluded from committed examples.
